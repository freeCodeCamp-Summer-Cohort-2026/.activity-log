...
Pulled in all cohort repos and focused mainly on the Bookmarked project.  
Got the repo running locally and explored the structure.  
Reviewed several repos but noticed many were in languages I’m less familiar with, so I decided to focus on Bookmarked.
...
Spent time debugging Jest/TypeScript issues and learning the project structure. I checked if i could pick up some more issues in other repos but i couldnt really find anything 
